...
<body>
        ...
        <ul class="nav container justify-content-around">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="catalogo-higiene.html">Todos os produtos de Higiene Pessoal</a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="catalogo-casa.html">Todos os produtos de Casa e Ambiente</a>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a class="text-dark text-decoration-none" href="./quem-somos.html">Quem
                                somos</a></h5>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a class="text-dark text-decoration-none"
                                href="./como-funciona.html">Como funciona</a></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a class="text-dark text-decoration-none" href="./fale-conosco.html">Fale
                                conosco</a></h5>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a class="text-dark text-decoration-none" href="/produto/{id}">Sabonete
                                vegano</a>
                        </h5>
                        <p class="card-text">R$ 20.00</p>
                        <div class="btn-produto">
                            <a href="./produto.html" class="btn text-light">Comprar</a>
                            <a href=""><i class="material-icons">
                                    favorite_border
                                </i></a>
                        </div>
    ...
    <div class="titulo mt-5">
        <h5 class="text-center">Novidades</h5>
    </div>
